...
// Dimension: kalite boyutu (Usability, Reliability, Accessibility)
// her dimension'ın kendi adı, senaryo içindeki ağırlığı (coefficient)
// birden fazla metriği var
public class Dimension {

    private String name;           // ör: "Usability" ... 
    private int coefficient;       // senaryo içindeki ağırlığı
    ...
    // dimension'a yeni metriks eklemek için
